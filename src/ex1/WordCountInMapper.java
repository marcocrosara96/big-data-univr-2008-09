...
public class WordCountInMapper extends Configured implements Tool {
  ...
  private static final Logger LOG = Logger.getLogger(WordCountInMapper.class);

  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new WordCountInMapper(), args); //Viene avviata un'istanza di World Count (args: <file input>, <dir output>, <#reducer>)
    System.exit(res);
  }
