...
//SERIALIZZAZIONE ---- DESERIALIZZAZIONE DEL DATO SU E DA DISCO
    ...
    /**
     * SERIALIZZAZIONE => Gli dico come salvare i dati su disco    es. disco--> ||w1|w2 .... ||
     * @param out
     * @throws IOException
     */
    @Override
    ...
    /**
     * Chiamato dal partitioner
     * SUGGERIMENTO: w1.hashCode ^ w2.hashCode (mod #R --> lo fa Hadoop)
     * @return
     */
    @Override
    public int hashCode() {
    ...
    public boolean equals(Object o) {
        if(this.first.equals(((TextPair)o).first) && this.second.equals(((TextPair)o).second))
            return true;
        return false;
    }

    /**
     * Trasforma gli oggetti(text) in String
    ...
    public int compareTo(TextPair tp) {
        int firstCompare = this.first.compareTo(tp.first);
        if(firstCompare != 0)
            return firstCompare;
